                    ...
                    <div>
                        ...
                        <div className="mb-4">
                            ...
                            <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-black bg-gradient-to-r from-lime-400 via-yellow-500 to-lime-600 hover:brightness-125 transition-all shadow-[0_0_20px_#84cc16] border border-lime-500/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(3)}
                            ...
                            <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-black bg-gradient-to-br from-yellow-600 via-lime-500 to-green-700 hover:brightness-125 transition-all shadow-[0_0_25px_#a3e635] border border-lime-400/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(4)}
                    ...
                    <div>
                        ...
                        <div className="mb-4">
                            ...
                            <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-black bg-gradient-to-r from-purple-500 via-violet-600 to-purple-700 hover:brightness-125 transition-all shadow-[0_0_25px_#9d4edd] border border-purple-500/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(2)}
                            ...
                            <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-black bg-gradient-to-r from-violet-600 via-purple-700 to-indigo-600 hover:brightness-125 transition-all shadow-[0_0_20px_#7b2cbf] border border-violet-500/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(3)}
                            ...
                            <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-black bg-gradient-to-r from-purple-600 via-indigo-500 to-violet-700 hover:brightness-125 transition-all shadow-[0_0_15px_#5a189a] border border-purple-700/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(4)}
                        ...
                        <div className="mb-4">
                            ...
                            <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-black bg-gradient-to-r from-green-400 via-emerald-500 to-lime-500 hover:brightness-125 transition-all shadow-[0_0_25px_#00ff88] border border-green-400/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(4)}
                            ...
                            <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-black bg-gradient-to-r from-lime-500 via-green-500 to-emerald-600 hover:brightness-125 transition-all shadow-[0_0_20px_#38b000] border border-lime-400/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(0)}
                            ...
                            <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-black bg-gradient-to-r from-emerald-400 via-green-600 to-lime-600 hover:brightness-125 transition-all shadow-[0_0_15px_#007200] border border-emerald-600/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(1)}
                        ...
                        <div className="mb-4">
                            ...
                            <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-black bg-gradient-to-r from-red-500 via-rose-600 to-red-600 hover:brightness-125 transition-all shadow-[0_0_25px_#ff3c00] border border-red-500/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(1)}
                                <span>RED ALERT</span>
                                {getIcon(1)}
                            </Button>
                            <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-black bg-gradient-to-r from-rose-600 via-red-600 to-pink-600 hover:brightness-125 transition-all shadow-[0_0_20px_#ff0055] border border-rose-500/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(2)}
                            ...
                            <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-black bg-gradient-to-r from-red-600 via-rose-700 to-red-700 hover:brightness-125 transition-all shadow-[0_0_15px_#cc0000] border border-red-700/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(3)}
                        ...
                        <div className="mb-4">
                            ...
                            <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-black bg-gradient-to-r from-blue-500 via-cyan-500 to-blue-600 hover:brightness-125 transition-all shadow-[0_0_25px_#0099ff] border border-blue-500/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(3)}
                            ...
                            <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-black bg-gradient-to-r from-sky-500 via-blue-600 to-indigo-500 hover:brightness-125 transition-all shadow-[0_0_20px_#0066ff] border border-sky-500/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(4)}
                            ...
                            <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-black bg-gradient-to-r from-blue-600 via-cyan-600 to-sky-700 hover:brightness-125 transition-all shadow-[0_0_15px_#0044cc] border border-blue-700/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(0)}
                         ...
                         <div>
                            ...
                            <Button 
                             ...
                             <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-yellow-300 bg-gradient-to-tr from-yellow-600 to-amber-800 hover:brightness-125 transition-all shadow-[0_0_20px_#b45309] border border-yellow-700/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(0)}
                            ...
                            <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-black bg-gradient-to-r from-yellow-500 via-yellow-400 to-yellow-600 hover:brightness-125 transition-all shadow-[0_0_25px_#ffdd00] border border-yellow-500/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(0)}
                            ...
                            <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-black bg-gradient-to-r from-yellow-200 via-white to-yellow-300 hover:brightness-125 transition-all shadow-[0_0_25px_#fde047] border border-yellow-300/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(2)}
                            ...
                            <Button 
                                ...
                                className="w-full h-20 mb-2 flex items-center justify-center gap-4 text-xl font-bold text-black bg-gradient-to-br from-lime-400 via-yellow-400 to-amber-500 hover:brightness-125 transition-all shadow-[0_0_25px_#a3e635] border border-lime-400/50 bg-[length:200%_auto] animate-background-shine">
                                {getIcon(4)}
                                <span>CYBER BEE</span>
                                {getIcon(4)}
                            </Button>
