...
export default function FakeQuizIncorrectPage() {
    return (
            ...
            <Card className="w-full max-w-lg shadow-2xl">
                ...
                <CardContent className="flex flex-col items-center justify-center p-6 space-y-8">
                    <div className="w-full space-y-4">
                        <div className="w-full flex justify-around gap-4 text-center">
                            ...
                            <div className="flex items-center gap-2">
                                <Clock className="h-6 w-6" />
                                <span className="text-2xl font-bold">00:11</span>
                            </div>
                        </div>
                    ...
                    <div className="text-center space-y-2">
                        ...
                        <p className="font-headline font-bold text-4xl">"Throughout"?</p>
                    </div>
                    
                    <div data-tutorial-id="quiz-incorrect-answer" className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                        <Button className="h-auto text-lg p-4 whitespace-normal bg-muted text-muted-foreground opacity-70">Wewnątrz</Button>
                        <Button className="h-auto text-lg p-4 whitespace-normal bg-destructive text-destructive-foreground">Na zewnątrz</Button>
                        <Button className="h-auto text-lg p-4 whitespace-normal bg-muted text-muted-foreground opacity-70">Pod spodem</Button>
                        <Button className="h-auto text-lg p-4 whitespace-normal bg-success text-success-foreground">Przez cały (czas)</Button>
                    </div>
                ...
                <CardFooter className="flex-col gap-4 p-6 pt-0">
                    <div className="flex justify-between w-full items-center">
                        <div className="text-sm text-muted-foreground">Pytanie 2 z 2</div>
                        <div className="flex items-center gap-2">
