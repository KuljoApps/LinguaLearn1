                ...
                <CardContent className="flex flex-col space-y-4 p-6 pt-0 pb-4">
                    <div className="grid grid-cols-2 gap-4">
                        <Link href="/quizzes" passHref>
                             <Button variant={theme ? undefined : "outline"} className={cn(buttonBaseClasses, squareButtonClasses, "rounded-xl", "font-normal", theme ? theme.className : defaultThemeClasses, isGradientTheme && 'bg-[length:300%_300%] animate-gradient-flow')}>
                                <LayoutGrid className={cn("h-16 w-16", theme ? 'text-white' : 'text-deep-purple')} />
                                <span className={cn(theme ? 'text-white' : '')}>Quizzes</span>
                            </Button>
                        </Link>
                         <Link href="/games" passHref>
                            <Button variant={theme ? undefined : "outline"} className={cn(buttonBaseClasses, squareButtonClasses, "rounded-xl", "font-normal", theme ? theme.className : defaultThemeClasses, isGradientTheme && 'bg-[length:300%_300%] animate-gradient-flow')}>
                                <Gamepad2 className={cn("h-16 w-16", theme ? 'text-white' : 'text-deep-purple')} />
                                <span className={cn(theme ? 'text-white' : '')}>Games</span>
                            </Button>
                        </Link>
                    </div>
                    <div className="flex flex-col space-y-2">
                        <Button variant={theme ? undefined : "outline"} className={cn(rectButtonClasses, "gap-2 text-lg", "font-normal", "rounded-xl", theme ? theme.className : defaultThemeClasses, isGradientTheme && 'bg-[length:300%_300%] animate-gradient-flow')}>
