...
export const allAchievements: Achievement[] = [
  ...
  // Time Spent
  { id: 'time_1h', name: 'Time Traveler', name_fr: 'Voyageur Temporel', name_de: 'Zeitreisender', name_it: 'Viaggiatore del Tempo', name_es: 'Viajero del Tiempo', description: 'Spend 30 seconds learning in total.', description_fr: 'Passer 30 secondes à apprendre au total.', description_de: 'Verbringe insgesamt 30 Sekunden mit Lernen.', description_it: 'Passa 30 secondi a imparare in totale.', description_es: 'Pasa 30 segundos aprendiendo en total.', icon: Clock, goal: 30 },
