...
import { ThumbsUp, Clock, CheckCircle, ShieldX } from 'lucide-react';
import React from 'react';

export default function FakeQuizResultsPage() {
        ...
        <main className="flex min-h-screen flex-col items-center justify-center p-4">
            <Card className="w-full max-w-lg shadow-2xl">
                <CardHeader className="items-center text-center pb-4">
                    ...
                    <CardTitle className="text-3xl font-bold">Dobry wynik!</CardTitle>
                    <CardDescription>Jesteś na dobrej drodze. Ćwicz dalej aby opanować język do perfekcji!</CardDescription>
                </CardHeader>
                            ...
                            <CardContent className="grid grid-cols-2 gap-4 text-center">
                                ...
                                <div className="flex flex-col items-center justify-center p-2 rounded-lg bg-background col-span-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-2xl font-bold">00:15</span>
                                    </div>
                ...
                <CardFooter className="flex-col gap-4 pt-4" data-tutorial-id="quiz-results-actions">
                    <div className="flex w-full gap-4">
                        <Button className="w-full pointer-events-none opacity-50">Zagraj ponownie</Button>
                        <Button variant="outline" className="w-full pointer-events-none opacity-50">Wróć do menu</Button>
                    </div>
